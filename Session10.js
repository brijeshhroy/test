...
record.readFile("D:\\FileSync-creations\\Level 1\\Test1.txt", 'utf-8',
    (err, info) => {
        ...
        if (info) {
                ...
                (error, daata) => {
                    ...
                    if (daata) {
                        ...
                        record.writeFile("D:\\NODEJS\\FreeCodeCamp\\1\\2\\Async.txt", daata + info
                            ...
                            console.log("one");  //this will print when system is waiting for first write to complete
            ...
            console.log("three");    // this will print under info condition &  when system is waiting for second readfile to complete
...
console.log("World")   // this is happening when system is waiting for first readfile to complete
